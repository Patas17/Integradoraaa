namespace Flower_Grow
{
	partial class Agregar_Planta
	{
		...
		private void InitializeComponent()
		{
			...
			lbl_Titulo.Location = new Point(191, 182);
			lbl_Titulo.Name = "lbl_Titulo";
			lbl_Titulo.Size = new Size(0, 25);
			lbl_Titulo.TabIndex = 0;
			// 
			// lbl_Subtitulo
			// 
			lbl_Subtitulo.AutoSize = true;
			lbl_Subtitulo.Location = new Point(341, 53);
			lbl_Subtitulo.Name = "lbl_Subtitulo";
			lbl_Subtitulo.Size = new Size(0, 25);
			...
			lblClasificacion.Location = new Point(499, 97);
			lblClasificacion.Name = "lblClasificacion";
			lblClasificacion.Size = new Size(317, 40);
			...
			lbl_Especie.Location = new Point(499, 163);
			lbl_Especie.Name = "lbl_Especie";
			lbl_Especie.Size = new Size(98, 32);
			...
			label5.Location = new Point(759, 127);
			label5.Name = "label5";
			...
			lbl_Clase.Location = new Point(816, 270);
			lbl_Clase.Name = "lbl_Clase";
			lbl_Clase.Size = new Size(75, 32);
			...
			txtGenero.Location = new Point(611, 262);
			txtGenero.Multiline = true;
			txtGenero.Name = "txtGenero";
			txtGenero.Size = new Size(180, 41);
			...
			lbl_Division.Location = new Point(816, 373);
			lbl_Division.Name = "lbl_Division";
			lbl_Division.Size = new Size(104, 32);
			...
			label8.Location = new Point(793, 200);
			label8.Name = "label8";
			...
			lbl_Genero.Location = new Point(499, 263);
			...
			lbl_Orden.Location = new Point(816, 172);
			lbl_Orden.Name = "lbl_Orden";
			lbl_Orden.Size = new Size(86, 32);
			...
			label11.Location = new Point(1666, 100);
			...
			lbl_Familia.Location = new Point(499, 383);
			lbl_Familia.Name = "lbl_Familia";
			lbl_Familia.Size = new Size(94, 32);
			...
			lbl_Caracteristicas.Location = new Point(1177, 97);
			lbl_Caracteristicas.Name = "lbl_Caracteristicas";
			lbl_Caracteristicas.Size = new Size(214, 38);
			...
			txt_Tamaño.Location = new Point(1293, 170);
			txt_Tamaño.Name = "txt_Tamaño";
			txt_Tamaño.Size = new Size(180, 35);
			txt_Tamaño.TabIndex = 22;
			// 
			// label15
			// 
			label15.AutoSize = true;
			label15.Location = new Point(1089, 255);
			...
			lbl_Tamaño.Location = new Point(1179, 172);
			lbl_Tamaño.Name = "lbl_Tamaño";
			lbl_Tamaño.Size = new Size(105, 32);
			...
			label18.Location = new Point(1361, 262);
			...
			btn_Guardar.Location = new Point(999, 915);
			btn_Guardar.Name = "btn_Guardar";
			btn_Guardar.Size = new Size(249, 62);
			...
			btn_Actualizar.Location = new Point(1279, 915);
			btn_Actualizar.Name = "btn_Actualizar";
			btn_Actualizar.Size = new Size(249, 62);
			...
			// btn_Eliminar
			// 
			btn_Eliminar.BackColor = Color.FromArgb(192, 57, 43);
			...
			btn_Eliminar.Location = new Point(1557, 915);
			btn_Eliminar.Name = "btn_Eliminar";
			btn_Eliminar.Size = new Size(249, 62);
			...
			btn_Buscar.Location = new Point(713, 915);
			btn_Buscar.Name = "btn_Buscar";
			btn_Buscar.Size = new Size(249, 62);
			...
			lbl_Datos.Location = new Point(33, 97);
			lbl_Datos.Name = "lbl_Datos";
			lbl_Datos.Size = new Size(267, 40);
			...
			lbl_Nombre.Location = new Point(33, 182);
			lbl_Nombre.Name = "lbl_Nombre";
			lbl_Nombre.Size = new Size(107, 32);
			...
			txt_Nombre.Location = new Point(183, 180);
			...
			menu.Name = "menu";
			menu.Padding = new Padding(4, 3, 0, 3);
			menu.Size = new Size(1834, 39);
			menu.TabIndex = 41;
			...
			MenuCatalogo.Size = new Size(117, 33);
			...
			MenuAgregarPlanta.Size = new Size(181, 33);
			...
			MenuFavoritos.Size = new Size(123, 33);
			...
			MenuUsuarios.Size = new Size(109, 33);
			...
			txt_Descripcion.Location = new Point(183, 255);
			txt_Descripcion.Multiline = true;
			txt_Descripcion.Name = "txt_Descripcion";
			txt_Descripcion.Size = new Size(268, 151);
			...
			lblDescripcion.Location = new Point(33, 262);
			...
			lblTiposCuidado.Location = new Point(43, 435);
			lblTiposCuidado.Name = "lblTiposCuidado";
			lblTiposCuidado.Size = new Size(264, 40);
			...
			lblLuz.Location = new Point(33, 557);
			lblLuz.Name = "lblLuz";
			lblLuz.Size = new Size(80, 32);
			lblLuz.TabIndex = 45;
			lblLuz.Text = "1. Luz:";
			// 
			// lblRiego
			...
			lblRiego.Location = new Point(33, 760);
			lblRiego.Name = "lblRiego";
			lblRiego.Size = new Size(105, 32);
			...
			lblTemperatura.Location = new Point(499, 557);
			lblTemperatura.Name = "lblTemperatura";
			lblTemperatura.Size = new Size(180, 32);
			...
			lblLugarApropiado.Location = new Point(1049, 760);
			lblLugarApropiado.Name = "lblLugarApropiado";
			lblLugarApropiado.Size = new Size(210, 32);
			...
			lblFertilizantes.Location = new Point(1049, 557);
			lblFertilizantes.Name = "lblFertilizantes";
			lblFertilizantes.Size = new Size(171, 32);
			...
			lblSuelo.Location = new Point(520, 760);
			lblSuelo.Name = "lblSuelo";
			lblSuelo.Size = new Size(104, 32);
			...
			cmbLugar.Location = new Point(1279, 758);
			cmbLugar.Name = "cmbLugar";
			cmbLugar.Size = new Size(268, 35);
			...
			lblPlanta.Location = new Point(43, 927);
			lblPlanta.Name = "lblPlanta";
			lblPlanta.Size = new Size(102, 32);
			...
			// txt_ID
			// 
			txt_ID.Location = new Point(183, 923);
			txt_ID.Name = "txt_ID";
			txt_ID.Size = new Size(103, 31);
			txt_ID.TabIndex = 58;
			...
			btn_Borrar.Location = new Point(431, 915);
			btn_Borrar.Name = "btn_Borrar";
			btn_Borrar.Size = new Size(249, 62);
			...
			lblfoto.Location = new Point(1597, 118);
			lblfoto.Name = "lblfoto";
			lblfoto.Size = new Size(99, 32);
			lblfoto.TabIndex = 61;
			lblfoto.Text = "Imagen:";
			// 
			// ptbImagen
			// 
			ptbImagen.Location = new Point(1523, 182);
			ptbImagen.Name = "ptbImagen";
			ptbImagen.Size = new Size(256, 162);
			...
			btnCargarImagen.Location = new Point(1499, 370);
			btnCargarImagen.Name = "btnCargarImagen";
			btnCargarImagen.Size = new Size(307, 58);
